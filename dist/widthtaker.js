  ...
  function adjustSpacing(elem, targetWidth, minWidth, padding, paddingRight) {
    ...
    for (var i = 0; i < childrenEls.length; i++) {
      var oldProperties = reset(childrenEls[i]),
          ...
          remainingSpace = targetWidth - minWidth,
          // use minWidth for calculations
      ltrSpacing = 0,
          txtIndent = void 0;
      ...
      if (paddingRight) remainingSpace = remainingSpace >= paddingRight ? remainingSpace - paddingRight : 0;
